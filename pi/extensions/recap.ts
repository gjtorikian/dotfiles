...
// Resolved next to this file, not under $HOME: ~/.pi/agent symlinks individual
// entries into the dotfiles repo, so a homedir path would write outside it.
const CONFIG_PATH = path.join(fileURLToPath(new URL("../configs/", import.meta.url)), "recap.json");
